...
![](/website/docsite/docs/assets/RunningOnDeviceCodeSigning.png)
...
![](/website/docsite/docs/assets/RunningOnDeviceReady.png)
...
When trying to connect to the development server you might get a [red screen with an error](docs/debugging.md#in-app-errors-and-warnings) saying:
...
![](/website/docsite/docs/assets/XcodeBuildIP.png)
...
You can now enable Live reloading from the [Developer menu](docs/debugging.md#accessing-the-in-app-developer-menu). Your app will reload whenever your JavaScript code has changed.
...
3. You'll see a [red screen with an error](docs/debugging.md#in-app-errors-and-warnings). This is OK. The following steps will fix that.
4. Open the in-app [Developer menu](docs/debugging.md#accessing-the-in-app-developer-menu).
...
![](/website/docsite/docs/assets/ConfigureReleaseScheme.png)
