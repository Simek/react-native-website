...
- [View Style Props...](docs/view-style-props.md#style)

- **`textShadowOffset`**: object: {width: number,height: number}

- **`color`**: [color](docs/colors.md)
...
- **`textShadowColor`**: [color](docs/colors.md)
...
* **`textDecorationColor`**: [color](docs/colors.md) (_iOS_)
