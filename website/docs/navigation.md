...
The views in the stack navigator use native components and the [`Animated`](docs/animated.md) library to deliver 60fps animations that are run on the native thread. Plus, the animations and gestures can be customized.
