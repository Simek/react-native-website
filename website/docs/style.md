...
There are a lot more ways to customize text style. Check out the [Text component reference](docs/text.md) for a complete list.

Now you can make your text beautiful. The next step in becoming a style master is to [learn how to control component size](docs/height-and-width.md).
