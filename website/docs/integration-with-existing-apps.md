...
![Before RN Integration](/website/docsite/docs/assets/react-native-existing-app-integration-ios-before.png)
...
![Event Path](/website/docsite/docs/assets/react-native-add-react-native-integration-link.png)
...
![Event Path](/website/docsite/docs/assets/react-native-add-react-native-integration-wire-up.png)
...
![Home Screen](/website/docsite/docs/assets/react-native-add-react-native-integration-example-home-screen.png)

Here is the _React Native_ high score screen:

![High Scores](/website/docsite/docs/assets/react-native-add-react-native-integration-example-high-scores.png)
...
![Screenshot](/website/docsite/docs/assets/EmbeddedAppAndroid.png)
