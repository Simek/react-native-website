...
<center><img src="/website/docsite/docs/assets/DatePickerIOS/maximumDate.gif" width="360"></img></center>
...
See [`maximumDate`](docs/datepickerios.md#maximumdate) for an example image.
...
<center><img src="/website/docsite/docs/assets/DatePickerIOS/minuteInterval.png" width="360"></img></center>
...
Example with `mode` set to `date`, `time`, and `datetime`: ![](/website/docsite/docs/assets/DatePickerIOS/mode.png)
